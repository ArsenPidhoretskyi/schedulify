...
from schedulify.apps.accounts.api.v1.serializers.password import ChangePasswordSerializer
from schedulify.apps.accounts.exceptions import InvalidPasswordError, WrongPasswordError
...
@pytest.mark.django_db
def test_save(mocker, change_password_serializer_request):
    ...
    mocked_change_password.assert_called_once_with(change_password_serializer_request.user, NEW_PASSWORD)
